package peaksoft.instogram.config.jwt;
...
public class JwtService {
    ...
    public String generateToken(User user){
        ...
        return JWT.create()
                ...
                .withExpiresAt(ZonedDateTime.now().plusDays(6).toInstant())
                .sign(algorithm);
    }
    ...
    public User checkToken() {
        ...
        return userRepo.findUserByEmail(email).orElseThrow(()->new UsernameNotFoundException("User with email " + email + " not found"));
    }
}
